...
INSERT INTO `etat` VALUES ('CL','Saisie clôturée'),('CR','Fiche créée, saisie en cours'),('MP','Mise en Payement'),('RB','Remboursée'),('VA','Validée');
...
INSERT INTO `fichefrais` VALUES ('a131','202201',0,321.24,'2022-01-12','VA');
...
CREATE TABLE `lignefraisforfait` (
  ...
  CONSTRAINT `lignefraisforfait_ibfk_1` FOREIGN KEY (`idvisiteur`, `mois`) REFERENCES `fichefrais` (`idvisiteur`, `mois`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `lignefraisforfait` VALUES ('a131','202201','ETP',2),('a131','202201','KM',2),('a131','202201','NUI',0),('a131','202201','REP',2);
...
CREATE TABLE `lignefraishorsforfait` (
  ...
  CONSTRAINT `lignefraishorsforfait_ibfk_1` FOREIGN KEY (`idvisiteur`, `mois`) REFERENCES `fichefrais` (`idvisiteur`, `mois`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `lignefraishorsforfait` VALUES (20,'a131','202201','REFUSE : azerty1','2021-11-08',50.00),(21,'a131','202201','azerty2','2021-11-08',50.00);
...
-- Dump completed on 2022-02-01  1:00:02
